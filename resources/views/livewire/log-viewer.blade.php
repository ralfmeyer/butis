<div class="w-11/12 m-auto flex flex-col h-full">
    ...
    <div class="p-3 flatwhite flex flex-row items-center justify-between mb-2">
        <div class=" flex flex-row items-center">
            <div class="mr-10 text-xl font-bold text-sky-600 border-b border-sky-600">
            Log-Datei
            </div>
            <div>
            <button type="button" wire:click="loadLogs"
                class="mt-2 px-4 py-2 bg-sky-600 text-white rounded-md flex flex-row items-center shadow-md shadow-gray-400">
            <x-fluentui-open-28-o class="h-6 pr-2" />Log laden
            </div>
        </button>
        </div>
        <div>

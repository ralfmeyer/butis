...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-sans ">
        ...
        <div class="bg-gradient-to-br from-gray-300 to-white text-black/50 dark:bg-black dark:text-white/50">
            <!-- bg-gray-50 -->
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            -->
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex border bg-gray-100 rounded-md border-gray-300 p-4 shadow-md shadow-gray-300">
